...
const compositeSloResponse = {
  ...
  description: 'desc',
  members: [
    { id: 'slo-1', name: 'Availability SLO', instanceId: 'FEMALE', weight: 2, normalisedWeight: 0.67, sliValue: 0.99, contribution: 0.66 },
    { id: 'slo-2', name: 'Latency SLO', weight: 1, normalisedWeight: 0.33, sliValue: 0.98, contribution: 0.32 },
  ],
...
describe('useFetchCompositeSlo', () => {
  ...
  it('fetches each unique sloId only once', async () => {
    const responseWithDuplicateSlo = {
      ...
      members: [
        { id: 'slo-1', name: 'Availability SLO', instanceId: 'FEMALE', weight: 1, normalisedWeight: 0.5, sliValue: 0.99, contribution: 0.5 },
        { id: 'slo-1', name: 'Availability SLO', instanceId: 'MALE', weight: 1, normalisedWeight: 0.5, sliValue: 0.99, contribution: 0.5 },
      ],
    };
