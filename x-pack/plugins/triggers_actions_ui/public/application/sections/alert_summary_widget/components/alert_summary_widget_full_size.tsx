...
export const AlertSummaryWidgetFullSize = (props: AlertSummaryWidgetFullSizeProps) => {
  const { activeAlertCount, recoveredAlertCount, hideChart } = props;
  return (
    <EuiPanel
      element="div"
    ...
    >
      <EuiFlexGroup>
        ...
        <EuiFlexItem>{!hideChart && <AlertsChart {...props} />}</EuiFlexItem>
      </EuiFlexGroup>
    </EuiPanel>
  );
};
